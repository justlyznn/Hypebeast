<footer class="bg-black text-white py-12 px-6">
        <div class="max-w-7xl mx-auto">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">HYPEBEAST</h3>
                    <p class="text-gray-400 text-sm">
                        Your ultimate destination for streetwear and lifestyle products. Discover the latest trends and
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-white">Business Relations</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        ...
                        <li><a href="#" class="hover:text-white">Help & FAQ</a></li>
                    </ul>
                </div>
                <div>
            ...
            <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                <p>© 2024 HYPEBEAST. All rights reserved.</p>
