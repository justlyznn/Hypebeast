    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-4">
                ...
                <div class="aspect-square bg-gray-100 rounded-lg overflow-hidden">
                    <img src="<?= base_url('./hypebeast/img/inspect1.png') ?>" alt="Air Jordan I Retro High Off-White Chicago" class="w-full h-full object-cover">
                </div>
                
                <!-- Thumbnail Images -->
                <div class="grid grid-cols-4 gap-4">
                    <div class="aspect-square bg-gray-100 rounded-lg overflow-hidden cursor-pointer border-2 border-black">
        ...
        <section class="mt-20">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="group relative bg-gray-50 rounded-lg overflow-hidden">
                    <div class="aspect-square relative">
                        <img src="<?= base_url('./hypebeast/img/sepatu5.png') ?>" alt="Nike GT Cut 2 University Red" class="w-full h-full object-cover">
                        <button class="absolute top-4 right-4 text-red-500 hover:text-red-600">
                            <i class="fas fa-heart"></i>
                        </button>
                        <button class="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <div class="group relative bg-gray-50 rounded-lg overflow-hidden">
                    <div class="aspect-square relative">
                        <img src="<?= base_url('./hypebeast/img/sepatu2.png') ?>" alt="Nike Zoom Kobe 5 Protro" class="w-full h-full object-cover">
                        <button class="absolute top-4 right-4 text-red-500 hover:text-red-600">
                            <i class="fas fa-heart"></i>
                        </button>
                        <button class="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div class="p-4">
                        <h3 class="font-medium text-sm mb-1">Nike Zoom Kobe 5 Protro</h3>
                        <p class="text-lg font-bold">$1,000.00</p>
                    </div>
                </div>
                ...
                <div class="group relative bg-gray-50 rounded-lg overflow-hidden">
                    <div class="aspect-square relative">
                        <img src="<?= base_url('./hypebeast/img/sepatu4.png') ?>" alt="Adidas Next Level Shock Red" class="w-full h-full object-cover">
                        <button class="absolute top-4 right-4 text-red-500 hover:text-red-600">
                            <i class="fas fa-heart"></i>
                        </button>
                        <button class="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
                    ...
                    <div class="p-4">
                        <h3 class="font-medium text-sm mb-1">Adidas Next Level Shock Red</h3>
                        <p class="text-lg font-bold">$1,000.00</p>
                    </div>
                </div>
                ...
                <div class="group relative bg-gray-50 rounded-lg overflow-hidden">
                    <div class="aspect-square relative">
                        <img src="<?= base_url('./hypebeast/img/sepatu2.png') ?>" alt="Adidas Yeezy 350 V2" class="w-full h-full object-cover">
                        <button class="absolute top-4 right-4 text-red-500 hover:text-red-600">
                            <i class="fas fa-heart"></i>
                        </button>
                        <button class="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <div class="group relative bg-gray-50 rounded-lg overflow-hidden">
                    <div class="aspect-square relative">
                        <img src="<?= base_url('./hypebeast/img/sepatu3.png') ?>" alt="Nike GT Cut 2 University Red" class="w-full h-full object-cover">
                        <button class="absolute top-4 right-4 text-red-500 hover:text-red-600">
                            <i class="fas fa-heart"></i>
                        </button>
                        <button class="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <div class="group relative bg-gray-50 rounded-lg overflow-hidden">
                    <div class="aspect-square relative">
                        <img src="<?= base_url('./hypebeast/img/sepatu4.png') ?>" alt="Nike Zoom Kobe 5 Protro" class="w-full h-full object-cover">
                        <button class="absolute top-4 right-4 text-red-500 hover:text-red-600">
                            <i class="fas fa-heart"></i>
                        </button>
                        <button class="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <div class="group relative bg-gray-50 rounded-lg overflow-hidden">
                    <div class="aspect-square relative">
                        <img src="<?= base_url('./hypebeast/img/sepatu5.png') ?>" alt="Adidas Next Level Shock Red" class="w-full h-full object-cover">
                        <button class="absolute top-4 right-4 text-red-500 hover:text-red-600">
                            <i class="fas fa-heart"></i>
                        </button>
                        <button class="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
